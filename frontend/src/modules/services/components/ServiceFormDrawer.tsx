...
export const ServiceFormDrawer: React.FC<Props> = ({
    ...
    return (
        <Drawer open={open} onClose={onClose}>
            <h2 className="text-xl font-bold mb-6 text-zinc-100">{defaultValues ? "Edit Service" : "New Service"}</h2>
            ...
            >
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                        ...
                        className="w-full bg-zinc-900 border border-zinc-700 rounded-2xl px-3 py-3 text-sm text-white focus:outline-none focus:border-indigo-500 transition-colors min-h-[100px] resize-y"
                ...
                <div className="pt-4 flex gap-3 mt-2">
                    ...
                    <Button type="submit" className="flex-1 bg-indigo-600 hover:bg-indigo-500 text-white">Save Service</Button>
                </div>
            </form>
        </Drawer>
    );
